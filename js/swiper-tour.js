...
var Swiper = (function () {
  ...
  function h(e) {
    return (
      e.querySelector(".tour-swiper-slide-transform") ||
      (e.shadowRoot && e.shadowRoot.querySelector(".tour-swiper-slide-transform")) ||
      e
    );
  }
  function f(e, t) {
  ...
  const ge = [
    function (e) {
      ...
      function c(e, t, a) {
        ...
        f(s.slidesEl, ".tour-swiper-slide, swiper-slide").forEach((e) => {
          e.style[y] = M - Math.abs(s.cssOverflowAdjustment()) + "px";
        }),
          C();
      }
